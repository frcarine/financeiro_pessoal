...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Dashboard"
        subtitle="Resumo financeiro do mes e indicadores recentes."
      />

      <section className="grid gap-4 md:grid-cols-3">
        <MetricCard title="Saldo atual" value={currency(summary.balance)} tone={summary.balance >= 0 ? 'income-text' : 'expense-text'} />
        <MetricCard title="Receitas do mes" value={currency(summary.totalIncome)} tone="income-text" />
        <MetricCard title="Despesas do mes" value={currency(summary.totalExpense)} tone="expense-text" />
      </section>
